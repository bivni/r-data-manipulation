---
title: "data manipulation 1  С‚СЂРµРЅРёСЂРѕРІРѕС‡РЅС‹Рµ СѓРїСЂР°Р¶РЅРµРЅРёСЏ 2"
author: "Ilya Kochergin"
date: '24 РјР°СЂС‚Р° 2016 Рі '
output:
...
```{r,echo=F}
  ...
  inner_join(x=.,city_t %>% filter(Population>7e6), by="CountryCode") %>% 
  group_by(Region ) %>% 
  summarize(count=n())
